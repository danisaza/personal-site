...
const PodcastsPage = () => (
  <Layout>
    ...
    <p>
      ...
      is an interview series that features some of the most notable names in the
      indie software community.
    </p>
    <p>
    ...
    <p>
      If you're interested in online businesses, this podcast is a must-listen.
    </p>
    ...
    <p>
      ...
      technical topics, and I recommend listening in an environment where you'll
      be able to focus.
    </p>
    <p>
      Of course, you won't walk away an expert from having listened to a podcast
      episode about something, but it's a great way to get a thorough overview
      of a specific topic.
    </p>
    ...
    <p>
      ...
      , Guy Podjarny - the CEO of Snyk - hosts various security experts to talk
      about tooling and best practices for promoting security within your
      organization.
    </p>
    <p>
